...
<head>
    ...
    <title>Apple iPhone 13 Pro Max - 256GB (Sierra Blue) - New Tech</title>
        ...
        <div class="row">
            ...
            <div class="d-md-flex">
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="phones/Apple-iPhone-13-Pro-Max-Sierra-Blue-01.jpg" class="d-block mx-auto proimage">
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img src="phones/Apple-iPhone-13-Pro-Max-Sierra-Blue-03.jpg" class="d-block mx-auto proimage">
                            </div>
                            <div class="carousel-item">
                                <img src="phones/Apple-iPhone-13-Pro-Max-Sierra-Blue-04.jpg" class="d-block mx-auto proimage">
                            </div>
                            <div class="carousel-item">
                                <img src="phones/Apple-iPhone-13-Pro-Max-Sierra-Blue-05.jpg" class="d-block mx-auto proimage">
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg 7">
                    ...
                    <div class="row">
                        <h1>Apple iPhone 13 Pro Max - 256GB (Sierra Blue)</h1>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-2 col-lg-1">
                            <a href="singleProduct.php" class="col1"></a>
                        </div>
                        <div class="col-2 col-lg-1">
                            <a href="singleProduct2.php" class="col2"></a>
                        </div>
                    </div>

                    <div class="py-3 px-auto">
                        <button class="btn btn-danger col-5">Add to cart <i class="bi bi-cart-check"></i></button>
                        <button class="btn btn-success col-5">Add to watchlist <i class="bi bi-bag-heart"></i></button>
                    </div>
            ...
            <div><h3 class="pt-3">Related Items <hr></h3></div>
            <div class="col d-flex mx-2">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xl-2 card">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 card">
                            <img class="card-img-top" src="phones/SMG-SM-A035F-BU-128GB-01.jpg">
                            <div class="card-text card-img-overlay"></div>
                            <div class="card-body">
                                <div class="card-title"><h4>Samsung Galaxy A03 (32GB) (D-Blue)</h4></div>
                                <div class="card-subtitle">3 more available.</div>
                                <div class="card-footer px-0">
                                    <h4>Rs.492,400</h4>
                                </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 card">
                            <img class="card-img-top" src="phones/SMG-SM-A035F-B-128GB-01.jpg">
                            <div class="card-text card-img-overlay"></div>
                            <div class="card-body">
                                <div class="card-title"><h4>Samsung Galaxy A03 (32GB) (Black)</h4></div>
                                <div class="card-subtitle">3 more available.</div>
                                <div class="card-footer px-0">
                                    <h4>Rs.492,400</h4>
                                </div>
