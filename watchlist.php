...
<body>
    ...
    <div class="container-fluid">
        <div class="row"> 
            ...
            <div><h1>Watchlist <hr></h1></div>

            <div class="col-11 alert alert-info mx-auto my-3" role="alert">
                
                <h4 class="alert-heading"><i class="bi bi-bookmark-heart display-6"></i> Your watchlist is empty!!!</h4>
                <p>Looks like you haven't added anything to your watchlist yet. </p>
                <hr>
                <button class="btn btn-info">Go Explore Now
